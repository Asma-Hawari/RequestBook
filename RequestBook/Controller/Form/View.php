 ...
 */
namespace CodaTrip\RequestBook\Controller\Form;
...
class View extends \Magento\Contact\Controller\Index implements HttpPostActionInterface
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccessMessage(
                __('Thanks for requesting a new book. We\'ll respond to you very soon.')
            );
            $this->dataPersistor->clear('request_book');
